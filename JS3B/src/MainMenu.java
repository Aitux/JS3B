...
public class MainMenu{
	...
	public MainMenu(){
		...
		m=new Monde(t,s);
		v=new Vague(m);
		coordonnePlay[0]=m.terrain.tableau.length/2;
		coordonnePlay[1]=(m.terrain.tableau[0].length/2) -2 ;
		coordonneQuit[0]=m.terrain.tableau.length/2;
		coordonneQuit[1]=(m.terrain.tableau[0].length/2) ;
